    ...
    >
      ...
      <div className="space-y-4">
        <div className="relative bg-off-white p-5 overflow-hidden">
          ...
          <span className="overline-text text-light-gray block mb-1">CORTES DE CABELLO</span>
          <p className="font-sans text-[12px] text-light-gray">Según tu rostro y la imagen circular...</p>
        </div>
        ...
        <div className="relative bg-off-white p-5 overflow-hidden">
          ...
          <span className="overline-text text-light-gray block mb-1">ACCESORIOS + LENTES</span>
          <p className="font-sans text-[12px] text-light-gray">Formas ideales para tu tipo de rostro...</p>
        </div>
      </div>

      <div className="space-y-4">
        <Button fullWidth onClick={() => navigate('/paywall')}>DESBLOQUEAR</Button>
        <div className="text-center">
          <button 
            onClick={() => setView('color')}
            className="font-sans text-[11px] text-mid-gray tracking-[0.1em] uppercase underline underline-offset-4"
          >
            Continuar con color gratis
          </button>
        </div>
      </div>
    </motion.div>
  ...
  const renderColor = () => (
    ...
    >
      ...
      <div className="relative bg-off-white p-5 overflow-hidden">
        ...
        <span className="overline-text text-light-gray block mb-1">SIMBOLOGÍA DEL COLOR</span>
        <p className="font-sans text-[12px] text-light-gray">{colorDiagnosis?.symbology || 'Descubre la psicología de tus colores ideales...'}</p>
      </div>

      <div className="space-y-4">
        <Button fullWidth onClick={() => navigate('/paywall')}>VER DIAGNÓSTICO COMPLETO</Button>
        <div className="text-center">
          <button 
            onClick={() => setView('summary')}
            className="font-sans text-[11px] text-mid-gray tracking-[0.1em] uppercase underline underline-offset-4"
          >
            Siguiente: tipo de cuerpo
          </button>
        </div>
      </div>
    </motion.div>
    ...
    >
      ...
      <div className="flex gap-[1px] bg-light-gray border border-light-gray">
        ...
        <div className="flex-1 bg-off-white py-6 px-2 text-center space-y-2">
          ...
          <Lock className="w-3.5 h-3.5 text-mid-gray mx-auto" />
          <p className="font-sans text-[11px] text-mid-gray uppercase">Pendiente</p>
        </div>
      </div>
      ...
      <Button 
        fullWidth 
        className="bg-black text-white hover:bg-charcoal hover:text-white"
